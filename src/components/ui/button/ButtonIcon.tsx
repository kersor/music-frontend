...
export const ButtonIcon = ({
    ...
    const classNames_size: Record<size, string> = {
        xs: styles.buttonIcon_size__xs,
        sm: styles.buttonIcon_size__sm, 
        md: styles.buttonIcon_size__md,
        lg: styles.buttonIcon_size__lg, 
        xl: styles.buttonIcon_size__xl,
    }
...
const Content = ({
    ...
    return (
        <div className={styles.buttonIcon_content}>
            {
                loading ? (
